...
## Project Structure
    ...
    ├── sparkling_bonus_dev_90281  # Django project configurations
...
1. Clone this repo and `cd sparkling_bonus_dev_90281`
...
2. Clone this repo and `cd sparkling_bonus_dev_90281`
